...
function initThree() {
  ...
  const colorPalette = [new THREE.Color('#4f9eff'), new THREE.Color('#8b5cf6'), new THREE.Color('#22d3ee'), new THREE.Color('#ec4899')]
  ...
  const material = new THREE.PointsMaterial({ size: 0.02, vertexColors: true, transparent: true, opacity: 0.6, blending: THREE.AdditiveBlending, depthWrite: false })
  ...
  function animate() {
    ...
    particles.rotation.y = t * 0.03; particles.rotation.x = t * 0.015
    torus.rotation.x = t * 0.15; torus.rotation.y = t * 0.1
    torus2.rotation.y = -t * 0.08; torus2.rotation.z = t * 0.12
